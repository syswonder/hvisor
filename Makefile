...
sudo qemu-system-aarch64 \
	...
	\
	-drive if=none,file=fsimg,id=hd0,format=raw \
...
update-img:
	make m -C /media/clk/c21/qemu-linux && \
	sudo cp $(target_bin) /media/clk/c21/qemu-linux/rootfs/boot && \
	make um -C /media/clk/c21/qemu-linux
