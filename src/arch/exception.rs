...
use crate::memory::{MMIOAccess, mmio_handle_access};
...
fn handle_smc(frame: &mut TrapFrame) {
    ...
    match code & SMC_TYPE_MASK {
        smc_type::STANDARD_SC => handle_psci(frame, code, arg0, arg1, arg2),
        _ => {
...
fn handle_psci(frame: &mut TrapFrame, code: u64, arg0: u64, _arg1: u64, _arg2: u64) {
    match code {
        psci_fn_id::PSCI_CPU_OFF_32 => unsafe {
            park_current_cpu();
