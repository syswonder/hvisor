...
impl Iommu for ArmSmmu {
    ...
    fn iommu_flush_all(&self) {
        todo!("ArmSmmu flush all not implemented yet.");
    }
    fn iommu_flush_s2pt_cache(&self, zone_id: usize) {
        todo!(
            "ArmSmmu flush s2pt cache for VMID {} not implemented yet.",
            zone_id
        );
    }
    fn iommu_flush_dev_dir_cache(&self, device_id: usize) {
        todo!(
            "ArmSmmu flush dev dir cache for device id {} not implemented yet.",
            device_id
        );
    }
