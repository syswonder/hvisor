...
pub const ROOT_PCI_DEVS: [HvPciDevConfig; 18] = [
    ...
    pci_dev!(0x0, 0x0, 0x2, 0x0 => 0x0, 0x2, 0x0, VpciDevType::Physical), // VGA controller
    pci_dev!(0x0, 0x0, 0x4, 0x0 => 0x0, 0x4, 0x0, VpciDevType::Physical),
    pci_dev!(0x0, 0x0, 0x8, 0x0 => 0x0, 0x8, 0x0, VpciDevType::Physical),
    pci_dev!(0x0, 0x0, 0xa, 0x0 => 0x0, 0xa, 0x0, VpciDevType::Physical),
    // pci_dev!(0x0, 0x0, 0xd, 0x0), // USB controller
    pci_dev!(0x0, 0x0, 0x12, 0x0 => 0x0, 0x12, 0x0, VpciDevType::Physical), // serial controller
    ...
    pci_dev!(0x0, 0x0, 0x14, 0x3 => 0x0, 0x14, 0x3, VpciDevType::Physical), // network controller
    pci_dev!(0x0, 0x0, 0x16, 0x0 => 0x0, 0x16, 0x0, VpciDevType::Physical), // communication controller
    pci_dev!(0x0, 0x0, 0x1c, 0x0 => 0x0, 0x1c, 0x0, VpciDevType::Physical), // PCI bridge
    ...
    pci_dev!(0x0, 0x0, 0x1f, 0x3 => 0x0, 0x1f, 0x3, VpciDevType::Physical), // audio controller
    ...
    pci_dev!(0x0, 0x2, 0x0, 0x0 => 0x2, 0x0, 0x0, VpciDevType::Physical),  // memory controller
];
